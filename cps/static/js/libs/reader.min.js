...
!(function (a, b) {
    ...
    function d (a, b) {
        if (2 !== arguments.length) return wa[a]
        wa[a] = b
    }
    function e (a) {
        var b = typeof a
        ...
        1 ===
            Aa.push({
                ...
                payload: {
                    ...
                    label: b._label,
                    timeStamp: za(),
                    error: wa['instrument-with-stack']
                        ? new Error(b._label)
                        : null,
                },
            }) && i()
    ...
    function u (a, b) {
        a._state === Ba &&
            ((a._result = b),
            (a._state = Ca),
            0 === a._subscribers.length
                ? wa.instrument && j('fulfilled', a)
                : wa.async(x, a))
    }
    function v (a, b) {
        a._state === Ba && ((a._state = Da), (a._result = b), wa.async(t, a))
    }
    function w (a, b, c, d) {
        ...
        ;(a._onError = null),
            ...
            (e[f + Ca] = c),
            (e[f + Da] = d),
            0 === f && a._state && wa.async(x, a)
    }
    function x (a) {
        var b = a._subscribers,
            c = a._state
        if (
            (wa.instrument && j(c === Ca ? 'fulfilled' : 'rejected', a),
            0 !== b.length)
        ) {
            for (
    ...
    function A (a, b, c, d) {
        var e = f(c),
            ...
            h = void 0
        if (e) {
            if ((g = z(c, d)) === Fa) (h = g.error), (g.error = null)
            else if (g === b) return void v(b, l())
        } else g = d
        b._state !== Ba ||
            (e && void 0 === h
                ? s(b, g)
    ...
    function C (a, b, c) {
        var d = this,
            e = d._state
        if ((e === Ca && !a) || (e === Da && !b))
            return wa.instrument && j('chained', d, d), d
        d._onError = null
        var f = new d.constructor(m, c),
            g = d._result
        if ((wa.instrument && j('chained', d, f), e === Ba)) w(d, f, a, b)
        else {
            var h = e === Ca ? a : b
            wa.async(function () {
                return A(e, f, h, g)
    ...
    function F (a, b) {
        ...
        for (var e = 0; d._state === Ba && e < a.length; e++)
            w(
                c.resolve(a[e]),
                void 0,
                function (a) {
    ...
    function Q (a, b, c, d) {
        var e = L(c, d, b)
        return e === Ka && v(a, e.value), a
    }
    function R (a, b, c, d) {
        return Ja.all(b).then(function (b) {
            var e = L(c, d, b)
            return e === Ka && v(a, e.value), a
        })
    }
    function S (a) {
        return !(!a || 'object' != typeof a) && (a.constructor === Ja || K(a))
    }
    function T (a, b) {
        return Ja.all(a, b)
    }
    ...
    function ea (a, b, c) {
        return ya(a)
            ? f(b)
                ? Ja.all(a, c).then(function (a) {
                      for (
                          var d = a.length, e = new Array(d), f = 0;
                          f < d;
                          f++
                      )
                          e[f] = b(a[f])
    ...
    function fa (a, b) {
        return Ja.resolve(a, b)
    }
    function ga (a, b) {
        return Ja.reject(a, b)
    }
    function ha (a, b) {
        return Ja.all(a, b)
    }
    function ia (a, b) {
        return Ja.resolve(a, b).then(function (a) {
            return ha(a, b)
        })
    }
    function ja (a, b, c) {
        return ya(a) || (g(a) && void 0 !== a.then)
            ? f(b)
                ? (ya(a) ? ha(a, c) : ia(a, c)).then(function (a) {
                      for (
                          var d = a.length, e = new Array(d), f = 0;
                          f < d;
                          f++
    ...
    function ka (a, b) {
        ;(Xa[Qa] = a), (Xa[Qa + 1] = b), 2 === (Qa += 2) && Ya()
    }
    function la () {
        var a = process.nextTick,
            b = process.versions.node.match(
                /^(?:(\d+)\.)?(?:(\d+)\.)?(\*|\d+)$/
            )
        return (
            Array.isArray(b) &&
    ...
    function pa () {
        return function () {
            return setTimeout(qa, 1)
        }
    }
    function qa () {
        for (var a = 0; a < Qa; a += 2) {
            ;(0, Xa[a])(Xa[a + 1]), (Xa[a] = void 0), (Xa[a + 1] = void 0)
        }
        Qa = 0
    }
    function ra () {
        try {
            var a = require,
                b = a('vertx')
            return (Ra = b.runOnLoop || b.runOnContext), ma()
        } catch (a) {
            return pa()
        }
    }
    ...
    var va = {
            ...
            on: function (a, d) {
                ...
                var e = c(this),
                    f = void 0
                ;(f = e[a]), f || (f = e[a] = []), -1 === b(f, d) && f.push(d)
            },
            off: function (a, d) {
                var e = c(this),
                    f = void 0,
                ...
                ;(f = e[a]), -1 !== (g = b(f, d)) && f.splice(g, 1)
            },
            trigger: function (a, b, d) {
                var e = c(this),
                    f = void 0
                if ((f = e[a]))
                    for (var g = 0; g < f.length; g++) (0, f[g])(b, d)
            },
        },
        wa = { instrument: !1 }
    va.mixin(wa)
        ...
        Ga = (function () {
            function a (a, b, c, d) {
                ;(this._instanceConstructor = a),
                    (this.promise = new a(m, d)),
                    (this._abortOnReject = c),
                    this._init.apply(this, arguments)
            }
            return (
                (a.prototype._init = function (a, b) {
                    var c = b.length || 0
                    ;(this.length = c),
                        (this._remaining = c),
                        (this._result = new Array(c)),
                        this._enumerate(b),
                        0 === this._remaining && u(this.promise, this._result)
                }),
                (a.prototype._enumerate = function (a) {
                    for (
                        var b = this.length, c = this.promise, d = 0;
                        c._state === Ba && d < b;
                        d++
                    )
                        this._eachEntry(a[d], d)
                }),
                (a.prototype._settleMaybeThenable = function (a, b) {
                    ...
                    if (d === k) {
                        ...
                        if (e === C && a._state !== Ba)
                            ...
                            this._remaining--,
                                (this._result[b] = this._makeResult(Ca, b, a))
                        else if (c === Ja) {
                            var f = new c(m)
        ...
        Ja = (function () {
            function a (b, c) {
                ;(this._id = Ia++),
                    ...
                    (this._result = void 0),
                    (this._subscribers = []),
                    wa.instrument && j('created', this),
                    m !== b &&
                        ('function' != typeof b && H(),
                        this instanceof a ? B(this, b) : I())
            }
            return (
                ...
                (a.prototype.catch = function (a, b) {
                    return this.then(void 0, a, b)
                }),
                (a.prototype.finally = function (a, b) {
                    var c = this,
                        d = c.constructor
                    return c.then(
                        function (b) {
    ...
    ;(Ja.cast = k),
        ...
        (Ja.resolve = k),
        (Ja.reject = G),
        (Ja.prototype._guidKey = Ha),
        (Ja.prototype.then = C)
    var Ka = new J(),
        La = new J(),
        Ma = (function (a) {
            function b (b, c, d) {
                return U(this, a.call(this, b, c, !1, d))
            }
            return V(b, a), b
        })(Ga)
    Ma.prototype._makeResult = D
    var Na = Object.prototype.hasOwnProperty,
        Oa = (function (a) {
            function b (b, c) {
                var d =
                        ...
                        arguments[2],
                    e = arguments[3]
                return Y(this, a.call(this, b, c, d, e))
            }
            return (
                Z(b, a),
                ...
                (b.prototype._enumerate = function (a) {
                    var b = this.promise,
                        c = []
                    for (var d in a)
                        Na.call(a, d) && c.push({ position: d, entry: a[d] })
                    var e = c.length
                    this._remaining = e
                    for (var f = void 0, g = 0; b._state === Ba && g < e; g++)
                        (f = c[g]), this._eachEntry(f.entry, f.position)
                }),
                b
            )
        })(Ga),
        Pa = (function (a) {
            function b (b, c, d) {
                return _(this, a.call(this, b, c, !1, d))
            }
            return aa(b, a), b
        })(Oa)
    Pa.prototype._makeResult = D
    var Qa = 0,
        Ra = void 0,
        Sa = 'undefined' != typeof window ? window : void 0,
        Ta = Sa || {},
        Ua = Ta.MutationObserver || Ta.WebKitMutationObserver,
        Va =
    ...
    Ya = Va
        ...
        : Wa
        ? oa()
        : void 0 === Sa && 'function' == typeof require
        ? ra()
        : pa()
    ...
    if (
        ...
        d('instrument', !0)
        for (var bb in ab) ab.hasOwnProperty(bb) && ta(bb, ab[bb])
    }
    var cb =
        ((Za = {
            asap: ka,
...
;(EPUBJS.core.getEl = function (a) {
    ...
    (EPUBJS.core.request = function (a, b, c) {
        ...
        return (
            ...
            'xml' == b &&
                ((h.responseType = 'document'), h.overrideMimeType('text/xml')),
            'xhtml' == b && (h.responseType = 'document'),
    ...
    (EPUBJS.core.uri = function (a) {
        ...
        return 0 === f
            ...
            : (-1 != i && ((e.fragment = a.slice(i + 1)), (a = a.slice(0, i))),
              -1 != h &&
                  ((e.search = a.slice(h + 1)),
                  (a = a.slice(0, h)),
                  (href = e.href)),
              -1 != g
                  ? ((e.protocol = a.slice(0, g)),
                    (b = a.slice(g + 3)),
                    (d = b.indexOf('/')),
                    -1 === d
                        ? ((e.host = e.path), (e.path = ''))
                        : ((e.host = b.slice(0, d)), (e.path = b.slice(d))),
              ...
              -1 != c && (e.extension = e.filename.slice(c + 1)),
              e)
    }),
    ...
    (EPUBJS.core.dataURLToBlob = function (a) {
        ...
        ;(b = a.split(g)),
            ...
            (e = d.length),
            (f = new Uint8Array(e))
        for (var h = 0; h < e; ++h) f[h] = d.charCodeAt(h)
    ...
    (EPUBJS.core.prefixed = function (a) {
        ...
        for (var e = 0; e < d; e++)
            if (void 0 !== document.documentElement.style[b[e] + c])
                return b[e] + c
        return a
    }),
    ...
    (EPUBJS.core.getElementTreeXPath = function (a) {
        ...
        for (
            ...
            ((b = EPUBJS.core.indexOfTextNode(a) + 1),
            f.push('text()[' + b + ']'),
            (a = a.parentNode));
            a && 1 == a.nodeType;
            a = a.parentNode
            ...
            for (var h = a.previousSibling; h; h = h.previousSibling)
                h.nodeType != Node.DOCUMENT_TYPE_NODE &&
                    h.nodeName == a.nodeName &&
                    ++b
    ...
    (EPUBJS.core.indexOfTextNode = function (a) {
        for (
            ...
            f < d.length &&
            ((b = d[f]), b.nodeType === Node.TEXT_NODE && e++, b != a);
            f++
        );
        return e
    }),
    ...
    (EPUBJS.core.indexOfNode = function (a, b) {
        for (
            var c, d = a.parentNode, e = d.childNodes, f = -1, g = 0;
            g < e.length && ((c = e[g]), c.nodeType === b && f++, c != a);
            g++
        );
        return f
    }),
...
;(EPUBJS.reader = {}),
    ...
    (EPUBJS.Reader = function (a, b) {
        ...
        ;(this.settings = EPUBJS.core.defaults(b || {}, {
            ...
            (this.book = c = new ePub(this.settings.bookPath, this.settings)),
            (this.offline = !1),
            (this.sidebarOpen = !1),
            this.settings.bookmarks || (this.settings.bookmarks = []),
            this.settings.annotations || (this.settings.annotations = []),
            this.settings.generatePagination &&
                c.generatePagination(g.width(), g.height()),
            (this.rendition = c.renderTo('viewer', {
            ...
            c.ready
                .then(
                    function () {
                        ;(f.ReaderController =
                            EPUBJS.reader.ReaderController.call(f, c)),
                            (f.SettingsController =
                                EPUBJS.reader.SettingsController.call(f, c)),
                            (f.ControlsController =
                                EPUBJS.reader.ControlsController.call(f, c)),
                            (f.SidebarController =
                                EPUBJS.reader.SidebarController.call(f, c)),
                            (f.BookmarksController =
                                EPUBJS.reader.BookmarksController.call(f, c)),
                            (f.NotesController =
                                EPUBJS.reader.NotesController.call(f, c)),
                            ...
                            this.rendition.on(
                                'keydown',
                                f.ReaderController.arrowKeys.bind(this)
                            ),
                            this.rendition.on(
                                'selected',
                                this.selectedRange.bind(this)
                            )
                    }.bind(this)
                )
                .then(
        ...
        for (d in EPUBJS.reader.plugins)
            EPUBJS.reader.plugins.hasOwnProperty(d) &&
                (f[d] = EPUBJS.reader.plugins[d].call(f, c))
        return (
            c.loaded.metadata.then(function (a) {
                f.MetaController = EPUBJS.reader.MetaController.call(f, a)
            }),
            c.loaded.navigation.then(function (a) {
    ...
    (EPUBJS.Reader.prototype.isSaved = function (a) {
        return (
            !!localStorage &&
            null !== localStorage.getItem(this.settings.bookKey)
        )
    }),
    ...
    (EPUBJS.Reader.prototype.saveSettings = function (local = true) {
        if (
            (this.book &&
                (this.settings.previousLocationCfi =
        ...
        if (!local)
            return {
                historyKey: this.settings.bookKey,
                historyValue: this.settings,
            }
    ...
    (EPUBJS.Reader.prototype.hashChanged = function () {
        ...
        this.rendition.display(a)
    }),
    (EPUBJS.Reader.prototype.selectedRange = function (a) {
        var b = '#' + a
        this.settings.history &&
            window.location.hash != b &&
            (history.pushState({}, '', b), (this.currentLocationCfi = a))
    }),
    ...
    (EPUBJS.reader.BookmarksController = function () {
        var a = this.book,
            ...
            i = function (c) {
                ...
                ;(d.id = 'bookmark-' + h), d.classList.add('list_item')
                var f,
                    g = a.spine.get(c)
                return (
                    g.index in a.navigation.toc
                        ? ((f = a.navigation.toc[g.index]),
                          (e.textContent = f.label))
                        : (e.textContent = c),
                    (e.href = c),
                    e.classList.add('bookmark_link'),
                    e.addEventListener(
                        'click',
                        function (a) {
                            var c = this.getAttribute('href')
                            b.display(c), a.preventDefault()
                        },
                        !1
                    ),
                    d.appendChild(e),
        ...
        return (
            this.settings.bookmarks.forEach(function (a) {
                var b = i(a)
                e.appendChild(b)
            }),
            d.append(e),
    ...
    (EPUBJS.reader.ControlsController = function (a) {
        var b = this,
            ...
            e =
                ...
                $('#slider')),
            f = ($('#main'), $('#sidebar'), $('#setting')),
            g = $('#bookmark')
        return (
            e.on('click', function () {
                b.sidebarOpen
                    ? (b.SidebarController.hide(),
                      e.addClass('icon-menu'),
                      e.removeClass('icon-right'))
                    : (b.SidebarController.show(),
                      e.addClass('icon-right'),
                      e.removeClass('icon-menu'))
            }),
            ...
            g.on('click', function () {
                var a = b.rendition.currentLocation().start.cfi
                ;-1 === b.isBookmarked(a)
                    ? (b.addBookmark(a),
                      g
            ...
            c.on('relocated', function (a) {
                ...
                ;-1 === b.isBookmarked(c)
                    ...
                    : g
                          .addClass('icon-bookmark')
                          .removeClass('icon-bookmark-empty'),
                    (b.currentLocationCfi = c),
                    b.settings.history &&
                        window.location.hash != d &&
                        history.pushState({}, '', d)
                setBookHistoryRemoteDebounce(b.saveSettings(false))
            }),
            {}
        )
    }),
        ...
        var a = this.book,
            ...
            n = function (d) {
                var e,
                    ...
                    m = a.renderer.doc
                if (
                    (m.caretPositionFromPoint
                        ? ((e = m.caretPositionFromPoint(d.clientX, d.clientY)),
                          (h = e.offsetNode),
                          (i = e.offset))
                        : m.caretRangeFromPoint &&
                          ((e = m.caretRangeFromPoint(d.clientX, d.clientY)),
                          (h = e.startContainer),
                          (i = e.startOffset)),
                    3 !== h.nodeType)
                )
                    for (var q = 0; q < h.childNodes.length; q++)
                        if (3 == h.childNodes[q].nodeType) {
                            h = h.childNodes[q]
                            break
                        }
                ;(i = h.textContent.indexOf('.', i)),
                    -1 === i ? (i = h.length) : (i += 1),
                    (j = k.generateCfiFromTextNode(
                        h,
                        i,
                        a.renderer.currentChapter.cfiBase
                    )),
                    (l = { annotatedAt: new Date(), anchor: j, body: f.val() }),
                    c.addNote(l),
                    o(l),
                    p(l),
                    f.val(''),
            ...
            p = function (b) {
                ...
                d.classList.add('footnotesuperscript', 'reader_generated'),
                    ...
                    (e.innerHTML = h.indexOf(b) + 1 + '[Reader]'),
                    d.appendChild(e),
                    k.addMarker(b.anchor, c, d),
                    q(d, b.body)
            },
            q = function (a, d) {
                var e = a.id,
                    f = function () {
                        ...
                        j[e] ||
                            ...
                            j[e].setAttribute('class', 'popup'),
                            (pop_content = document.createElement('div')),
                            j[e].appendChild(pop_content),
                            (pop_content.innerHTML = d),
                            pop_content.setAttribute('class', 'pop_content'),
                            i.render.document.body.appendChild(j[e]),
                            j[e].addEventListener('mouseover', g, !1),
                            j[e].addEventListener('mouseout', h, !1),
                            b.on('locationChanged', k, this),
                            b.on('locationChanged', h, this)),
                            (c = j[e]),
                            ...
                            (c.style.left = l - popRect.width / 2 + 'px'),
                            (c.style.top = m + 'px'),
                            p > n / 2.5 &&
                                ((p = n / 2.5),
                                (pop_content.style.maxHeight = p + 'px')),
                            popRect.height + m >= n - 25
                                ? ((c.style.top = m - popRect.height + 'px'),
                                  c.classList.add('above'))
                                : c.classList.remove('above'),
                            l - popRect.width <= 0
                                ? ((c.style.left = l + 'px'),
                                  c.classList.add('left'))
                                : c.classList.remove('left'),
                            l + popRect.width / 2 >= o
                                ? ((c.style.left = l - 300 + 'px'),
                                  (popRect = c.getBoundingClientRect()),
                                  (c.style.left = l - popRect.width + 'px'),
                                  popRect.height + m >= n - 25
                                      ? ((c.style.top =
                                            m - popRect.height + 'px'),
                                        c.classList.add('above'))
                    ...
                    g = function () {
                        j[e].classList.add('on')
                    },
                    h = function () {
                        j[e].classList.remove('on')
                    },
                    k = function () {
                        setTimeout(function () {
                            j[e].classList.remove('show')
                        }, 100)
                    },
                    m = function () {
                        c.ReaderController.slideOut(), l()
                    }
                a.addEventListener('mouseover', f, !1),
                    a.addEventListener('mouseout', k, !1),
                    a.addEventListener('click', m, !1)
            }
        return (
            g.on('click', function (a) {
                g.text('Cancel'), f.prop('disabled', 'true'), b.on('click', n)
            }),
    ...
    (EPUBJS.reader.ReaderController = function (a) {
        var b = $('#main'),
            ...
            h = this.rendition,
            i = function () {
                h.currentLocation().start.cfi
                g.settings.sidebarReflow
                    ? (b.removeClass('single'),
            ...
            p = function (b) {
                37 == b.keyCode &&
                    ('rtl' === a.package.metadata.direction
                        ? h.next()
                        : h.prev(),
                    f.addClass('active'),
                    (o = !0),
        ...
        return (
            ...
            e.on('click', function (b) {
                'rtl' === a.package.metadata.direction ? h.prev() : h.next(),
                    b.preventDefault()
            }),
            f.on('click', function (b) {
                'rtl' === a.package.metadata.direction ? h.next() : h.prev(),
                    b.preventDefault()
            }),
            h.on('layout', function (a) {
                !0 === a.spread ? m() : n()
            }),
            h.on('relocated', function (a) {
                a.atStart && f.addClass('disabled'),
                    a.atEnd && e.addClass('disabled')
            }),
            {
                slideOut: j,
                slideIn: i,
    ...
    (EPUBJS.reader.SettingsController = function () {
        ...
        return (
            $('#sidebarReflow').on('click', function () {
    ...
    (EPUBJS.reader.SidebarController = function (a) {
        var b = this,
            ...
            i = function () {
                ;(b.sidebarOpen = !1),
                    b.ReaderController.slideIn(),
                    c.removeClass('open')
            }
        return (
            d.find('.show_view').on('click', function (a) {
    ...
    (EPUBJS.reader.TocController = function (a) {
        var b = (this.book, this.rendition),
            c = $('#tocView'),
