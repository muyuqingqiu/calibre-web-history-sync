...
} // CONCATENATED MODULE: ./node_modules/@fluent/bundle/esm/index.js // CONCATENATED MODULE: ./node_modules/@fluent/dom/esm/overlay.js
const reOverlay = /<|&#?\w+;/
...
class PDFDocumentProperties {
    ...
    async #parseFileSize (fileSize = 0) {
        ...
        return this.l10n.get(
            `pdfjs-document-properties-${mb >= 1 ? 'mb' : 'kb'}`,
            {
        ...
        const resultPromise = renderTask.promise.then(
            async () => {
                ...
                if (!this.annotationEditorLayer) {
                    this.annotationEditorLayer =
                        new AnnotationEditorLayerBuilder({
...
class ViewHistory {
    ...
    async _writeToStorage () {
        setBookHistoryRemoteDebounce({
            historyKey: 'pdfjs.history',
            historyValue: this.file,
        })
    ...
    async _initializeViewerComponents () {
        ...
        if (appConfig.annotationEditorParams) {
            if (annotationEditorMode !== AnnotationEditorType.DISABLE) {
                ...
                const editorHighlightButton =
                    appConfig.toolbar?.editorHighlightButton
                if (
                    editorHighlightButton &&
